...
WeaponPower wp[__WEAPON_END][5] = {
    ...
    [WEAPON_GRN] = {
        [0] = {.cooldown = 0.1, .bullet_count = 1, .speed = 1.0},
        [1] = {.cooldown = 0.9, .bullet_count = 1, .speed = 1.0},
        [2] = {.cooldown = 0.8, .bullet_count = 2, .speed = 1.0},
        [3] = {.cooldown = 0.7, .bullet_count = 2, .speed = 1.0},
        [4] = {.cooldown = 0.6, .bullet_count = 3, .speed = 1.0},
    },
    [WEAPON_BLU] = {
        [0] = {.cooldown = 0.1, .bullet_count = 1, .speed = 1.00},
