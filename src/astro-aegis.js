...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = './astro-aegis.data';
      var REMOTE_PACKAGE_BASE = 'astro-aegis.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_./astro-aegis.data');

      };
      Module['addRunDependency']('datafile_./astro-aegis.data');
...
var wasmBinaryFile;
  wasmBinaryFile = 'astro-aegis.wasm';
...
var ___start_em_js = Module['___start_em_js'] = 85672;
var ___stop_em_js = Module['___stop_em_js'] = 85745;
