...
typedef struct {
    ...
    char * keyboard_char_mv_up;
    char * keyboard_char_mv_dn;
    char * keyboard_char_mv_lt;
    char * keyboard_char_mv_rt;
    char * keyboard_char_fr_up;
    char * keyboard_char_fr_dn;
    char * keyboard_char_fr_lt;
    char * keyboard_char_fr_rt;
    char * keyboard_char_wp_lt;
    char * keyboard_char_wp_rt;
    int gamepad;
